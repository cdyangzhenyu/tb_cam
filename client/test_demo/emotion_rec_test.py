...
def process_frame():
    ...
    while True:
        ...
        time_of_all = round((time.time()-time_of_all), 4)*1000
        ...
        print "time_of_all: %s, time_of_calc: %s, fps_num: %s" % (time_of_all, time_of_calc, current_fps)
        yield frameClone
